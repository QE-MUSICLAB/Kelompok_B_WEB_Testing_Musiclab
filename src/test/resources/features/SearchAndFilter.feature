Feature: Search And Filter
  ...
  @FilterInstrumentAndRating @SearchAndFilter @Musiclab @PositiveCase
  ...
  @FilterInstrument @SearchAndFilter @Musiclab @NegativeCase
  ...
  @FilterRating @SearchAndFilter @Musiclab @NegativeCase
  ...
  @AllFilterBlank @SearchAndFilter @Musiclab @NegativeCase
  ...
  @SearchAndFilterRating @SearchAndFilter @Musiclab @PositiveCase
  ...
  @SearchAndFilterRatingBlank @SearchAndFilter @Musiclab @NegativeCase
