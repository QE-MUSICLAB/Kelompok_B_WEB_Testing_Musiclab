Feature: User want edit mentor profile

  @EditMentorProfile @Musiclab @PositiveCase
  Scenario: Edit mentor profile with valid data
    Given User already on musiclab website
    When  User click login menu
    Then  User already in login page
    And   User input "sihombingthorir@gmail.com" as email,and input "tigor123" as password, and select "Mentor" as role
    ...
    And   User will input "tigorhutasoitt" as namaLengkap, input "Best Bass teacher in this town" as deskripsi select "Male" as jenisKelamin, "0855421512" as noHp, input "sihombingthorirr@gmail.com" asemail, input "@tigorimoet" as instagram account link, and input "Jalan Babarsari" as alamat
    When  User click update button
    And   User will get the pop up message success update mentor profile

  @EditMentorProfile @Musiclab @NegativeCase
